 ...
 */
public class PosJammer extends PosModule
{
    private double activationDuration,
                   ...
                   ladarStrength,
                   radarStrength,
                   magetometricStrength;

    public PosJammer(double requiredPowerGrid, double requiredCPU, double activationDuration, double activationProximity, double maxLockedTargets,
                     double scanResolution, double optimumRange, double accuracyFalloff, double gravimetricStrength, double ladarStrength,
                     double radarStrength, double magetometricStrength, boolean factionModule, double shieldCapacity, double shieldRechargeRate, 
                     double shieldEmResistance, double shieldExplosiveResistance, double shieldKineticResistance, double shieldThermalResistance, 
                     double armorHitpoints, double armorEmResitsance, double armorExplosiveResistance, double armorKineticResistance, 
                     double armorThermalResistance, double strutureHitpoints, double strutureEmResitsance, double strutureExplosiveResistance, 
                     ...
                     double unanchoringDelay, double onliningDelay, int mass, double volume, boolean playerControlable, String name,
                     String description, double basePrice)
    {
        super(factionModule, shieldCapacity, shieldRechargeRate, shieldEmResistance, shieldExplosiveResistance, 
              ...
              volume, playerControlable, "Jammer", name, description, basePrice, requiredPowerGrid, requiredCPU);
        ...
        this.gravimetricStrength = gravimetricStrength;
        this.ladarStrength = ladarStrength;
        this.radarStrength = radarStrength;
        this.magetometricStrength = magetometricStrength;
    }
    ...
    public double getGravimetricStrength()         {return gravimetricStrength;}    
    public double getLadarStrength()               {return ladarStrength;}    
    public double getRadarStrength()               {return radarStrength;}    
    public double getMagetometricStrength()        {return magetometricStrength;}    
}